...
Analyzed customer data to identify top customers using **RFM analysis**. Performed data cleaning, customer ranking, and insights reporting to support business decisions.
